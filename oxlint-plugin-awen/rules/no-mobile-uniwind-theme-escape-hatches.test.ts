...
const guardedMobileFile = createOxlintRuleHarness("awen/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness("awen/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/home/HomeHeader.tsx",
  ruleOptions: [{ allowUniwindTheme: true }],
});

describe("awen/no-mobile-uniwind-theme-escape-hatches", () => {
