...
const rule = createOxlintRuleHarness("awen/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("awen/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("awen/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("awen/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("awen/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
