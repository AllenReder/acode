...
const rule = createOxlintRuleHarness("awen/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("awen/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Awen";`);
