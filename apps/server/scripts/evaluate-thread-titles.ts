...
import { CodexSettings, ProviderInstanceId } from "@awen/contracts";
...
await Effect.runPromise(
  Effect.gen(function* () {
    ...
    const cwd = yield* fs.makeTempDirectoryScoped({ prefix: "awen-title-evaluation-" });
    ...
    Effect.provide(
      Layer.mergeAll(
        ...
        Layer.provideMerge(
          ServerConfig.layerTest(process.cwd(), { prefix: "awen-title-evaluation-state-" }),
        ),
