...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@awen/contracts";
import { VcsUnsupportedOperationError } from "@awen/contracts";
...
>()("@awen/server/vcs/VcsDriverRegistry") {}
