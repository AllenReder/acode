  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `awen-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Awen",
        GIT_AUTHOR_EMAIL: "awen@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Awen",
        GIT_COMMITTER_EMAIL: "awen@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `awen checkpoint ref=${input.checkpointRef}`;
