...
it("launch prompt stays a single argv-safe line naming the prompt file", () => {
  ...
  const launch = buildTriageLaunchPrompt(
    String.raw`C:\Users\a b\.awen\userdata\triage\x\prompt.md`,
  );
  assert.notInclude(launch, "\n");
  assert.include(launch, String.raw`C:\Users\a b\.awen\userdata\triage\x\prompt.md`);
...
it("context file carries every path the playbook depends on", () => {
  const context = buildTriageContext({
    ...
    os: "linux x64 (7.0.0)",
    nodeVersion: "v24.0.0",
    launchedAs: "npx awen triage",
    server: "running (pid 42, http://127.0.0.1:4501)",
    paths: {
      stateDir: "/home/u/.awen/userdata",
      dbPath: "/home/u/.awen/userdata/state.sqlite",
      settingsPath: "/home/u/.awen/userdata/settings.json",
      logsDir: "/home/u/.awen/userdata/logs",
      serverLogPath: "/home/u/.awen/userdata/logs/server.log",
      serverTracePath: "/home/u/.awen/userdata/logs/server.trace.ndjson",
      providerEventLogPath: "/home/u/.awen/userdata/logs/provider/events.log",
      terminalLogsDir: "/home/u/.awen/userdata/logs/terminals",
      providerStatusCacheDir: "/home/u/.awen/caches",
      secretsDir: "/home/u/.awen/userdata/secrets",
      sourceCacheDir: "/home/u/.awen/source",
    },
  });
  assert.include(context, "/home/u/.awen/userdata/state.sqlite");
  assert.include(context, "/home/u/.awen/userdata/logs/server.trace.ndjson");
  assert.include(context, "/home/u/.awen/userdata/logs/provider/events.log");
  assert.include(context, "/home/u/.awen/userdata/secrets");
  assert.include(context, "/home/u/.awen/source");
  assert.include(context, "npx awen triage");
