import type { ServerSelfUpdateOutcome } from "@awen/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different awen version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "@awen/server/service/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("@awen/server/service/serviceLauncherClient") {}
