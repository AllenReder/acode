...
} | null>("@awen/server/sourceControl/PinnedGitHubCredential", { defaultValue: () => null });

export const AllowGitHubReserve = Context.Reference<boolean>(
  "@awen/server/sourceControl/AllowGitHubReserve",
  { defaultValue: () => false },
);
...
>()("@awen/server/sourceControl/GitHubCli") {}
