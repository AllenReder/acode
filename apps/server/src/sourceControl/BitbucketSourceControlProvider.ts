...
import { SourceControlProviderError, type ChangeRequest } from "@awen/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set AWEN_BITBUCKET_EMAIL and AWEN_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
