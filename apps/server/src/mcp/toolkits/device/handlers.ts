...
import { nodeRuntimeUnavailableMessage } from "@awen/shared/nodeRuntime";
...
export function agentDeviceQuickStart(
  ...
  return [
    ...
    "For remote hosts, arrange builds, app installation, and any Metro reverse forwarding yourself. Awen provides discovery, streaming, and control only.",
