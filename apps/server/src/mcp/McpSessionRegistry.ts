import { ProviderInstanceId, ThreadId } from "@awen/contracts";
...
>()("@awen/server/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the `awen` toolkits on a remote-reachable server.
 */
