 ...
 */
import { type RemoteOpenTarget } from "@awen/contracts";
import { HostProcessHostname } from "@awen/shared/hostProcess";
import * as NetService from "@awen/shared/Net";
import { readTailscaleStatus } from "@awen/tailscale";
...
>()("@awen/server/environment/RemoteOpenTargets") {}
