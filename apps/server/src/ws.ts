  ...
  return Layer.merge(
    WsRpcGroup.toLayer(
      Effect.gen(function* () {
        ...
        const providerMaintenanceRunner =
            ...
            const runSetupProgram = () =>
              Effect.gen(function* () {
                if (!bootstrap?.runSetupScript || !targetWorktreePath) {
                  yield* track(
                    worktreeSetupTracker.stageStatus(threadId, "setup-script", "skipped"),
                  );
                  return null;
                }
        ...
        return WsRpcGroup.of({
          ...
          [WS_METHODS.attachmentsCreateUploadUrl]: (input) =>
            observeRpcEffect(
              ...
              issueAttachmentUploadUrl(input),
              {
                "rpc.aggregate": "workspace",
              },
            ),
          ...
          [WS_METHODS.terminalRename]: (input) =>
            observeRpcEffect(WS_METHODS.terminalRename, terminalManager.rename(input), {
              "rpc.aggregate": "terminal",
            }),
