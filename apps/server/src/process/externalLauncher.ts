...
// per-command cache lookups in @awen/shared/shell.
//
...
// command-resolution cache in @awen/shared/shell, so a backward wall-clock
...
>()("@awen/server/process/externalLauncher") {}
