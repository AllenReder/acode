  ...
  it.effect("links the same Forgejo number on two ports and unlinks an older portless record", () =>
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        repository: "allenreder/awen",
        number: 42,
        url: "http://forge.example:4000/allenreder/awen/pulls/42",
        source: "manual",
      });
  ...
  it.effect("legacy unlink cannot remove a newer cross-host link", () =>
    Effect.gen(function* () {
      ...
      const foreign = makeLink({
        ...
        url: "https://github.enterprise.test/allenreder/awen/pull/42",
    ...
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        linkedPullRequest: {
          ...
          repository: "allenreder/awen",
          number: 99,
          url: "https://github.com/allenreder/awen/pull/99",
        },
      });
