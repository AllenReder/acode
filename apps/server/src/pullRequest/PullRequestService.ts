...
import { detectSourceControlProviderFromRemoteUrl } from "@awen/shared/sourceControl";
...
} | null>("@awen/server/PullRequestService/routingCredential", { defaultValue: () => null });
...
>()("@awen/server/pullRequest/PullRequestService") {}
