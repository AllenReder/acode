...
import { EnvironmentHttpApi, ProviderDriverKind, type RepositoryIdentity } from "@awen/contracts";
...
import { disableTailscaleServe, ensureTailscaleServe } from "@awen/tailscale";
...
// Awen's primary transport is long-lived WebSocket RPC, whose Effect scope finalizer
...
const DesktopSshLayerLive = DesktopSshEnvironment.layer({
  resolveCliRunner: Effect.succeed({
    ...
    // The remote host must already provide this engine range; Awen never
