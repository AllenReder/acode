...
class OpenCodeAdapter extends Context.Service<OpenCodeAdapter, OpenCodeAdapterShape>()(
  "@awen/server/provider/Layers/OpenCodeAdapter.test/OpenCodeAdapter",
) {}
...
it.layer(OpenCodeAdapterTestLayer)("OpenCodeAdapterLive", (it) => {
  ...
  it.effect.skipIf(!symlinksSupported)(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const base = yield* fileSystem.makeTempDirectoryScoped({ prefix: "awen-opencode-dir-" });
  ...
  it.effect("logs native events against their Awen thread", () => {
