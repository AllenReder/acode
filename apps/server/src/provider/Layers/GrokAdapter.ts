...
import { stableStringify } from "@awen/shared/stableJson";
...
export function selectGrokPermissionOptionId(
  ...
  // Grok 4.6 often omits allow_always. Awen still offers "Always allow this session".
...
export function makeGrokAdapter(grokSettings: GrokSettings, options?: GrokAdapterLiveOptions) {
  return Effect.gen(function* () {
    ...
    /** Surface Grok plan.md as Awen's proposed-plan card (while writing + on exit). */
      ...
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const acp = yield* makeGrokAcpRuntime({
            ...
            clientInfo: { name: "awen", version: "0.0.0" },
            ...(mcpSession
              ? {
                  mcpServers: [
                    {
          ...
          const started = yield* Effect.gen(function* () {
            ...
            // Capture plan into Awen proposed-plan UI and abandon the native gate so
