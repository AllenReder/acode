import { tokenizeCliArgs } from "@awen/shared/cliArgs";

const AWEN_CODEX_LAUNCH_ARGS_ENV = "AWEN_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[AWEN_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
