          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  AWEN_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.awen.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.awen.bearer_token_env_var="AWEN_MCP_BEARER_TOKEN"',
                ],
