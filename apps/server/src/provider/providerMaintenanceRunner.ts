...
>()("@awen/server/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Awen could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Awen still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
