...
import type { ServerProviderSkill } from "@awen/contracts";
 ...
 * `os.path.expanduser` in the launch environment Awen hands the process:
 ...
 * skills. The agent resolves both under `GEMINI_HOME`, which Awen points at a
