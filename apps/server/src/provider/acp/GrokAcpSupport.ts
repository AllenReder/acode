import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@awen/contracts";
...
const AWEN_OAUTH_REFERRER = "awen";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: AWEN_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Awen's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
