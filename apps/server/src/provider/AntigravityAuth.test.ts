...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@awen/contracts";
...
const owner = "awen-auth-session-owner";
const otherOwner = "awen-auth-session-other";
