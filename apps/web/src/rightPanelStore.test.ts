...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "AllenReder/awen", number: 4909 };
    const second = { projectId: "project-a", repository: "AllenReder/awen", number: 4910 };
    useRightPanelStore.getState().openPullRequest(refA, first);
    useRightPanelStore.getState().openPullRequest(refA, second);
    const url = "https://gitlab.example.com/AllenReder/awen/-/merge_requests/4909";
