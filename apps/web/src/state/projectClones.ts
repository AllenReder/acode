...
import { parseScopedProjectKey, scopedProjectKey } from "@awen/client-runtime/environment";
import type { EnvironmentId, ProjectCloneSnapshot, ScopedProjectRef } from "@awen/contracts";
