import { BearerConnectionTarget, PrimaryConnectionTarget } from "@awen/client-runtime/connection";
import type { EnvironmentCatalogState } from "@awen/client-runtime/state/connections";
