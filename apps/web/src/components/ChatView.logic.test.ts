...
describe("deriveComposerSendState", () => {
  it("treats expired terminal pills as non-sendable content", () => {
    const state = deriveComposerSendState({
      prompt: "[Terminal 1 line 4](awen-context://v1/terminal/ctx-expired)",
      imageCount: 0,
      terminalContexts: [
        {
          id: "ctx-expired",
  ...
  it("keeps text sendable while excluding expired terminal pills", () => {
    const state = deriveComposerSendState({
      prompt: "yoo [Terminal 1 line 4](awen-context://v1/terminal/ctx-expired) waddup",
      imageCount: 0,
      terminalContexts: [
        {
          id: "ctx-expired",
        ...
        checkpoints: [
          {
            ...
            checkpointRef: CheckpointRef.make("refs/awen/checkpoints/1"),
            status: "ready",
            files: [],
            assistantMessageId: null,
            completedAt: now,
