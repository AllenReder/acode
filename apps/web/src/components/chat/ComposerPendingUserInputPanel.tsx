import { type ApprovalRequestId } from "@awen/contracts";
        ...
        <ComposerBanner.Body className="pe-1 pb-1">
          ...
          <div className="mt-2 space-y-0.5">
            {activeQuestion.options.map((option, index) => {
              ...
              const className = cn(
                "group flex w-full items-center gap-2 rounded-md px-2.5 py-2 text-left outline-none transition-colors [transition-duration:calc(150ms*var(--motion-duration-scale,1))] focus-visible:ring-1 focus-visible:ring-primary/25",
                isSelected
