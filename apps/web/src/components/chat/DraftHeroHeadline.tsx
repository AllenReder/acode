...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@awen/contracts";
import { scopedProjectKey, scopeProjectRef } from "@awen/client-runtime/environment";
