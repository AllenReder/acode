...
/** A light content backing; native blur belongs to the containing Material Surface. */
function Shell({
  contextStrip = false,
  className,
  ...props
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "dark:[html[data-theme-id]_&]:[--chat-composer-highlight:color-mix(in_srgb,var(--app-theme-input)_12%,transparent)] dark:[html[data-theme-id]_&]:[--chat-composer-outline:color-mix(in_srgb,var(--app-theme-input)_30%,var(--background))]",
        "before:pointer-events-none before:absolute before:inset-0 before:z-0 before:rounded-[22px] before:bg-[color-mix(in_srgb,var(--chat-composer-glass-surface)_20%,transparent)]",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-has-data-[composer-banner-surface=attached]/composer-surface:bg-[color-mix(in_srgb,var(--chat-composer-glass-surface)_20%,transparent)]",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-has-data-[composer-banner-surface=attached]/composer-surface:before:bg-[color-mix(in_srgb,var(--chat-composer-glass-surface)_20%,transparent)]",
        "not-supports-[clip-path:shape(from_0_0,line_to_1px_1px)]:before:bg-[color-mix(in_srgb,var(--chat-composer-glass-surface)_20%,transparent)]",
        className,
      )}
      {...props}
    />
