...
export const MOBILE_COMPOSER_VIEW_TRANSITION_NAME = "awen-mobile-composer";
export const MOBILE_DRAFT_HEADLINE_VIEW_TRANSITION_NAME = "awen-mobile-draft-headline";
