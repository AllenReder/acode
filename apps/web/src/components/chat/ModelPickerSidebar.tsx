...
import { type ProviderInstanceId } from "@awen/contracts";
          ...
          {selectedIndicatorTop !== null ? (
            <div
              ...
              className={cn(
                ...
                "right-0 translate-y-0 transition-[top] [transition-duration:calc(200ms*var(--motion-duration-scale,1))] ease-out",
              )}
