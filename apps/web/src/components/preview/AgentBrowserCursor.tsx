...
import type { DesktopPreviewPointerEvent } from "@awen/contracts";
...
function AgentBrowserCursorEvent(props: {
  ...
  return (
    <div
      className="pointer-events-none absolute left-0 top-0 z-40 transition-[transform,opacity] [transition-duration:calc(150ms*var(--motion-duration-scale,1))] ease-out motion-reduce:transition-none"
      style={{
