import type { DiscoveredLocalServer, ScopedThreadRef } from "@awen/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@awen/client-runtime/state/runtime";
