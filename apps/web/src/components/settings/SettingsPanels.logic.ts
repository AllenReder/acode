...
import { DEFAULT_UNIFIED_SETTINGS } from "@awen/contracts/settings";
import {
  getBackgroundActivityBaseProfile,
  normalizeBackgroundActivitySettings,
  normalizeServerBackgroundActivitySettings,
  resolveServerBackgroundActivitySettings,
} from "@awen/shared/backgroundActivitySettings";
...
const LAST_ENABLED_PROJECT_GROUPING_MODE_KEY = "awen:last-enabled-project-grouping-mode";
