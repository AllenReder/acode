                              ...
                              return (
                                ...
                                >
                                  <button
                                    ...
                                    className={cn(
                                      "absolute left-1/2 top-1 z-30 flex size-7 items-center justify-center rounded-full bg-background shadow-sm outline-none transition-[transform,opacity] [transition-duration:calc(200ms*var(--motion-duration-scale,1))] ease-out motion-reduce:transition-none focus-visible:ring-2 focus-visible:ring-ring",
                                    ...
                                    style={{
                                      ...
                                      transitionDelay: isOpen
                                        ? `calc(${optionIndex * 35}ms * var(--motion-duration-scale, 1))`
                                        : "0ms",
                                    }}
                                    type="button"
                                    onClick={(event) => {
