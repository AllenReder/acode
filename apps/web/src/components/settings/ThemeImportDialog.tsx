...
function ThemeJsonEditor({
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-border bg-background shadow-xs/5 focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/24">
      {isPlainText ? null : (
        <pre
          ref={highlightRef}
          aria-hidden
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-xs text-muted-foreground">
                      {fileName ?? "Drop Awen or VS Code .json files"}
                    </p>
                  </div>
                  {chooseButton()}
                  {fileInput}
