...
import { type ComposerContextClipboardFragment, type ServerProviderSkill } from "@awen/contracts";
import {
...
import { formatProviderSkillDisplayName } from "@awen/client-runtime/providerSkills";
...
export function ComposerPromptEditor({
  ...
  const initialConfig = useMemo<InitialConfigType>(
    () => ({
      namespace: "awen-composer-editor",
      editable: true,
      nodes: [
        ComposerMentionNode,
        ComposerSkillNode,
