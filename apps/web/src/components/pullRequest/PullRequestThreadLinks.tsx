...
import type { EnvironmentId, PullRequestRef, ScopedThreadRef, ThreadId } from "@awen/contracts";
...
import { normalizeThreadPullRequestKey } from "@awen/shared/threadPullRequests";
