...
/**
 * 3. 设置按钮与右侧细分割线之间的间距 (Separator Left Gap)
 * 默认 12px（控制设置按钮右侧到分割线的距离）。
 */
export const SEPARATOR_LEFT_GAP = 12;

/**
 * 4. 细分割线与右侧第一个 Tab 之间的间距 (Separator Right Gap)
...
export const COLLAPSED_TABS_INSET_MAC =
  DOCK_LEFT_MAC + TITLEBAR_BUTTON_SIZE + SEPARATOR_LEFT_GAP + 1 + SEPARATOR_RIGHT_GAP; // 110 + 28 + 12 + 1 + 12 = 163px

export const COLLAPSED_TABS_INSET_WIN =
  DOCK_LEFT_WIN + TITLEBAR_BUTTON_SIZE + SEPARATOR_LEFT_GAP + 1 + SEPARATOR_RIGHT_GAP; // 34 + 28 + 12 + 1 + 12 = 87px
