import type { ProjectScript, ProjectScriptIcon, ResolvedKeybindingsConfig } from "@awen/contracts";
import {
...
export interface ProjectScriptEditorRequest {
  ...
  /** Validation error to show immediately (e.g. a failed awen.json import). */
  error?: string;
}
