import type { GitRunStackedActionResult, GitStackedAction, VcsStatusResult } from "@awen/contracts";
import { isTemporaryWorktreeBranch } from "@awen/shared/git";
import {
...
export { resolveAutoFeatureBranchName } from "@awen/shared/git";
