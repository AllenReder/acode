...
import type { EnvironmentId, ProjectEntry } from "@awen/contracts";
...
import { AWEN_PIERRE_ICONS } from "~/pierre-icons";
...
export default function FileBrowserPanel({
  ...
  return (
    ...
    >
      <div
        className="flex h-10 min-h-10 shrink-0 items-center gap-1 border-b border-border/60 bg-transparent px-2 in-data-[preview-panel-mode=inline]:mb-1 in-data-[preview-panel-mode=inline]:h-9 in-data-[preview-panel-mode=inline]:min-h-9 in-data-[preview-panel-mode=inline]:border-b-transparent"
