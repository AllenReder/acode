...
const NO_FILE_SCRIPTS: ReadonlyArray<AwenProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in awen.json, offered for import. */
  fileScripts?: ReadonlyArray<AwenProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: AwenProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From awen.json</MenuGroupLabel>
