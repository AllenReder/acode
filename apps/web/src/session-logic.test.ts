...
import { resolveWorkEntryToolPresentation } from "@awen/client-runtime/work-log/presentation";
  ...
  it("preserves MCP server, tool, arguments, and results for expanded display", () => {
    ...
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        id: "mcp-tool-done",
        kind: "tool.completed",
        summary: "awen · preview_status",
        payload: {
          itemType: "mcp_tool_call",
          title: "awen · preview_status",
          toolSurface: "browser",
    ...
    const [entry] = deriveWorkLogEntries(activities);
    expect(entry?.toolTitle).toBe("awen · preview_status");
