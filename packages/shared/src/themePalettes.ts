...
function createPalette(base: {
  ...
  const dark: ThemeColors = {
    ...
    placeholder: "oklch(0.65 0.008 260)",
    secondaryLabel: "oklch(0.68 0.01 260)",
    iconMuted: "oklch(0.68 0.01 260)",
    ...
    sidebarMutedForeground: "oklch(0.68 0.01 260)",
  ...
  const light: ThemeColors = {
    ...
    secondaryLabel: "oklch(0.5 0.01 260)",
    iconMuted: "oklch(0.5 0.01 260)",
    ...
    sidebarMutedForeground: "oklch(0.5 0.01 260)",
