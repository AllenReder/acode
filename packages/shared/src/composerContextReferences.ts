...
/**
 * Canonical inline reference: `[label](awen-context://v1/<kind>/<contextId>)`, or the image
...
const CONTEXT_PROTOCOL = "awen-context:";
...
export function collectComposerContextReferences(
  ...
  if (!text.includes("](awen-context:")) return occurrences;
...
const CONTEXT_ENVELOPE_TAG = "awen_context";
...
/**
 * Captured text is data. A terminal line or PR comment that contains `</awen_context>` or
