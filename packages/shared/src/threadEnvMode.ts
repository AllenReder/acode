import type { ThreadEnvMode } from "@awen/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in awen.json > global server setting.
 *
 ...
 * source that outranks awen.json decided, or the file read settled. While
