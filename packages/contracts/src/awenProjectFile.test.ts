...
import { AwenProjectFile } from "./awenProjectFile.ts";

const decode = Schema.decodeUnknownSync(AwenProjectFile);

describe("AwenProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://awen.codes/schema/awen.json",
