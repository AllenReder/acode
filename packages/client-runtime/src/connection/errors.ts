import type { ClientConnectionMethod, EnvironmentId } from "@awen/contracts";
...
export function mapRemoteEnvironmentError(
  ...
  _connectionMethod: ClientConnectionMethod = "direct",
  ...
  switch (error._tag) {
    ...
    case "RemoteEnvironmentAuthUndeclaredStatusError":
      return new ConnectionTransientError({ reason: "remote-unavailable", detail: error.message });
  }
}
