...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/awen/OpenInPicker.tsx#L69",
      "D:/Programme/awen/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/awen/OpenInPicker.tsx", "D:/Programme/awen/OpenInPicker.tsx"],
    ["</D:/Programme/awen/ChatMarkdown.tsx:1>", "D:/Programme/awen/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\awen\\apps\\web\\a.ts", "C:/Users/mike/awen", "apps/web/a.ts"],
    ["/C:/Users/mike/awen/apps/web/a.ts", "C:/Users/mike/awen", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/awen/main.ts", "c:/users/MIKE/awen", "main.ts"],
    ["/C:/USERS/mike/awen/main.ts", "/c:/users/MIKE/awen", "main.ts"],
