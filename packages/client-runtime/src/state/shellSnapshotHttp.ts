import type { OrchestrationShellSnapshot } from "@awen/contracts";
 ...
 * Decouples the shell state machine from its HTTP fallback and keeps it out of
 * test contexts.
 */
...
>()("@awen/client-runtime/state/shellSnapshotHttp/ShellSnapshotLoader") {}
