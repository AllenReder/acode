import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@awen/contracts";
 ...
 * Decouples the thread state machine from its HTTP fallback and keeps it out
 * of test contexts.
 */
...
>()("@awen/client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}
